...
lean_object* initialize_Math190formalize(uint8_t builtin, lean_object*);
...
lean_dec_ref(res);
res = initialize_Math190formalize(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
